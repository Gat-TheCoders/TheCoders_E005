...
export const metadata: Metadata = {
  ...
  description: 'Create a personalized savings plan tailored to your income, expenses, and financial goals with AI-powered insights.',
};
      ...
      <ScrollReveal delay={0}>
         <header className="mb-10 text-center">
          ...
          <p className="mt-4 text-lg leading-8 text-foreground/80 max-w-2xl mx-auto">
            Define your financial goals and let our AI assistant help you craft a smart savings strategy to achieve them. All monetary values in INR.
          </p>
        </header>
      </ScrollReveal>
