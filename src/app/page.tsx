...
// Removed useState and useEffect as they are no longer needed for delayed loading or glow
import { cn } from '@/lib/utils';

export default function HomePage() {
  // Removed showRestOfPage and headingGlow states
  // Removed useEffect hook that managed timers for glow and content visibility
  ...
  return (
    <div className="container mx-auto py-12 px-4 md:px-6 lg:px-8">
      <section className="mb-16 text-center">
        {/* H1: Always rendered. Glow class is removed. */}
        <h1
          className={cn(
            "text-4xl font-bold tracking-tight sm:text-5xl lg:text-6xl animated-text-gradient"
            // Removed: headingGlow && "animate-text-glow-active" 
          )}
        >
          Welcome to Own Finance
        </h1>

        {/* Paragraph: Rendered immediately. */}
      ...
      {/* Features Section: Rendered immediately. */}
      <section>
