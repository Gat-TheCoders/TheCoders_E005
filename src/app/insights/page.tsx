...
import { ArrowLeft, DollarSign, Wallet, PackageOpen, PiggyBank, LineChart as LineChartIcon } from "lucide-react";
import { ScrollReveal } from '@/components/utils/scroll-reveal';
import { Card, CardContent, CardDescription, CardHeader, CardTitle } from '@/components/ui/card';
import { ChartContainer, ChartTooltip, ChartTooltipContent, ChartLegend, ChartLegendContent, type ChartConfig } from "@/components/ui/chart";
import { ComposedChart, Bar, Line, XAxis, YAxis, CartesianGrid, ResponsiveContainer } from 'recharts';

// Static metadata can be defined here for the /insights page
// export const metadata: Metadata = { // This would need to be in a server component or layout typically
...
export default function InsightsPage() {
  // Since metadata is preferred in server components/layouts, we can set document title here if needed
  // useEffect(() => {
  //   document.title = 'Financial Insights | Own Finance';
  // }, []);
    ...
    <div className="container mx-auto py-8 px-4 md:px-6 lg:px-8">
      <ScrollReveal delay={0}>
        <header className="mb-10 text-center">
           <LineChartIcon className="h-16 w-16 text-primary mx-auto mb-6" />
