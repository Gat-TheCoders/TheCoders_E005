...
export const metadata: Metadata = {
  title: 'Credit Score Simulator | Own Finance',
  description: 'Understand potential factors influencing your creditworthiness by simulating a score based on generalized transaction and mobile usage patterns.',
};
      ...
      <ScrollReveal delay={0}>
        <header className="mb-10 text-center">
          ...
          <p className="mt-4 text-lg leading-8 text-foreground/80 max-w-2xl mx-auto">
            Understand potential factors influencing your creditworthiness by simulating a score based on generalized transaction and mobile usage patterns.
          </p>
        </header>
      </ScrollReveal>
